...
const FIELD_MAPPINGS: FieldMapping[] = [
  ...
  { field: 'registered_capital', labels: ['注册资金', '注册资本', '注册资金(万)', '注册资本(万)', '注册资本(万元)', '注册资本金'] },
  { field: 'social_security_count', labels: ['社保人数', '参保人数', '缴纳社保人数', '社保', '参保人数所属年报'] },
  { field: 'region', labels: ['所在地区', '地区', '省市区', '所属地区', '区域', '省份', '城市', '地址区域', '所属省份', '所属城市', '所属区县', '所在省份', '所在城市', '所在区县'] },
  { field: 'industry_category', labels: ['行业分类', '所属行业', '行业', '主营行业', '行业类别', '一级行业', '国标行业门类', '国标行业大类'] },
  { field: 'industry_subcategory', labels: ['行业细分', '二级行业', '子行业', '国标行业中类', '国标行业小类'] },
  { field: 'contact_phone', labels: ['联系电话', '电话', '手机', '联系方式', '手机号', '座机', '电话号码', '年报电话', '往年年报电话', '企业电话'] },
  { field: 'contact_email', labels: ['邮箱', '电子邮箱', 'Email', 'E-mail', '邮件', '企业邮箱', '电子邮件'] },
  { field: 'address', labels: ['地址', '企业地址', '公司地址', '注册地址', '办公地址', '详细地址', '企业注册地址', '最新年报地址', '注册所在地'] },
  { field: 'website', labels: ['官网', '网址', '网站', '企业官网', '公司网址', '官网网址', '官方网站'] },
